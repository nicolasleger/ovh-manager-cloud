class CloudDbBackupCtrl {
    constructor ($stateParams, $translate, CloudDbActionService, CloudDbBackupService, ControllerHelper) {
        ...
        this.projetId = this.$stateParams.projectId;
        ...
        this.actions = {
            ...
            restoreBackup: {
                ...
                callback: backupId => this.CloudDbBackupService.restoreBackup(this.projectId, this.instanceId, backupId),
                isAvailable: () => true
            },
            deleteBackup: {
                ...
                callback: backupId => this.ControllerHelper.modal.showDeleteModal({
                    ...
                    onDelete: () => this.CloudDbBackupService.deleteBackup(this.projectId, this.instanceId, backupId)
                }),
                isAvailable: () => true
            }
        };
